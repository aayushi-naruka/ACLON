      ...
      <div className='footer-container'>
        ...
        <div className='second-block'>
          ...
          {productdata.map((item,index) => {
            return (
              <div key={index}>
                <NavLink className="footer-product-list orange-color" to={`/products/${item.name}`}> {item.name}</NavLink>
                <br></br>
              </div>
        ...
        <div className='third-block'>
          ...
          <br></br>
          <NavLink className="footer-product-list orange-color" color="inherit" to='/products'>
            Products
          </NavLink>
          <br></br>
          <NavLink className="footer-product-list orange-color" color="inherit" to='/about'>
            About Us
          </NavLink>
          <br></br>
          <NavLink className="footer-product-list orange-color" color="inherit" to='/contact'>
            Contact Us
          </NavLink>
        </div>
