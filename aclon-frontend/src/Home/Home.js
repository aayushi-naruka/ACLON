    ...
    return (
        ...
        <div className="about-section">
           <div className="about-section-description">
              ...
              <div className="learn-more-wrapper"><NavLink className="learn-more">Learn More</NavLink></div>
           </div>
        ...
        <div className="product-section">
           ...
           <div className="learn-more-wrapper-carousel"><NavLink to='/products' className="learn-more">Learn More</NavLink></div>
        </div>
        <div className="about-section">
           <div className="about-section-description">
              <h3>Manufacturing</h3>
              ...
              <div className="learn-more-wrapper"><NavLink to='/laboratory&manufacturing' className="learn-more">Learn More</NavLink></div>
           </div>
           <div className="about-section-image">
            ...
            <div>
                ...
                {isDropdownVisible && searchedValue.length !==0 && ( <div className='search-dropdown-container'>
                    ...
                    { filteredData.length !== 0 ? filteredData.map((item)=>{
                        return (
                        <li key={item.id} className="each-search-list-item">{item.name}</li>
                        )
